...
class DifferentialDriveRobotHardwareInterface : public hardware_interface::RobotHW
{
public:
  DifferentialDriveRobotHardwareInterface();
...
DifferentialDriveRobotHardwareInterface::DifferentialDriveRobotHardwareInterface()
: running_(true)
  , private_nh("~")
  , start_srv_(nh.advertiseService("start", &DifferentialDriveRobotHardwareInterface::start_callback, this))
  , stop_srv_(nh.advertiseService("stop", &DifferentialDriveRobotHardwareInterface::stop_callback, this)) 
  {
	...
	left_wheel_vel_pub_ = nh.advertise<std_msgs::Float32>("differential_drive_robot/left_wheel_vel", 1);
	right_wheel_vel_pub_ = nh.advertise<std_msgs::Float32>("differential_drive_robot/right_wheel_vel", 1);

	left_wheel_angle_sub_ = nh.subscribe("differential_drive_robot/left_wheel_angle", 1, &DifferentialDriveRobotHardwareInterface::leftWheelAngleCallback, this);
	right_wheel_angle_sub_ = nh.subscribe("differential_drive_robot/right_wheel_angle", 1, &DifferentialDriveRobotHardwareInterface::rightWheelAngleCallback, this);
}